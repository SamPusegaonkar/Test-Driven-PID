...
TEST(Test_Driven_PID, test_with_kp_ki_kd) {
   ...
   * (Δe) = 1.55 _____________ [5,1.55]
  */
  EXPECT_NEAR(pid_controller.ComputeError(10, 5), 1.55, 0.01);
  /**
   * Iteration 2
   * (Δe) = 1.55
   * ep = (0.3*1.55)  && ei = (0.01)(5+1.55/2) && ed = 0.2(5-1.55)
   * (Δe) = 1.5 _____________ [5,2.5,1.5]
  */
  EXPECT_NEAR(pid_controller.ComputeError(10, 6.55), 1.18775, 0.00001);
}
